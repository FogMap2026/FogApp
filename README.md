...
> 관광공사 OpenAPI 키를 넣고 스팟 수집 배치를 한 번 돌려야 합니다.
>
> ⚠️ **스팟 소개글(`overview`)은 아직 채워지지 않습니다.** 수집이 쓰는 `areaBasedList1`이 소개글을
> 주지 않아, 스팟을 해금해도 보여줄 내용이 없습니다. 상세조회 연동이 필요합니다 — [planning.md](planning.md) 병목 1번.
