...
public class FootprintController {
    ...
    public ResponseEntity<FootprintResponse> create(@AuthenticationPrincipal AuthUser me,
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(footprintService.toResponse(footprint, me.userId()));
    }

    @GetMapping("/{id}")
    public FootprintResponse get(@AuthenticationPrincipal AuthUser me, @PathVariable Long id) {
        return footprintService.toResponse(footprintService.get(id), me.userId());
    }
    ...
    public List<FootprintResponse> list(@AuthenticationPrincipal AuthUser me,
        ...
        return footprintService.toResponses(footprints, me.userId());
    }
    ...
    public FootprintResponse update(@AuthenticationPrincipal AuthUser me, @PathVariable Long id,
        ...
        return footprintService.toResponse(footprint, me.userId());
    }
