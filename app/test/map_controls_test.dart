...
void main() {
  testWidgets('화면 폭까지 늘어나지 않는다', (tester) async {
    await tester.pumpWidget(_host(
      MapControls(onZoomIn: () {}, onZoomOut: () {}, onRecenter: () {}),
    ));
  ...
  testWidgets('내 위치를 모르면 그 버튼만 비활성', (tester) async {
    await tester.pumpWidget(_host(
      MapControls(onZoomIn: () {}, onZoomOut: () {}, onRecenter: null),
    ));
  ...
  testWidgets('좌하단 버튼을 덮지 않는다', (tester) async {
          ...
          children: [
            Align(
              ...
              child: Padding(
                ...
                child: FilledButton(onPressed: () {}, child: const Text('발자취 남기기')),
              ),
            ),
            Align(
              alignment: Alignment.bottomRight,
              child: Padding(
                ...
                child: MapControls(onZoomIn: () {}, onZoomOut: () {}, onRecenter: () {}),
              ),
            ),
          ],
        ),
    ...
    expect(button.overlaps(controls), isFalse,
