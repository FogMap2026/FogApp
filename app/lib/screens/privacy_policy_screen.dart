          ...
          children: [
            ...
            const _Section(
              ...
              body:
                  ...
                  '• 여행 성향 — 성향이 유사한 동행 추천\n'
                  '• 위치공유 — 켠 경우에 한해, 가까운 스팟 근처에 있다는 사실을 다른 이용자에게 '
                  '익명·지연 공개(정복률에는 반영되지 않습니다)',
            ),
            const _Section(
              title: '3. 위치정보의 처리',
              body:
            ...
            const _Section(
              ...
              body:
                  ...
                  '• 「위치공유」로 게시된 위치는 마지막 갱신으로부터 2시간이 지나면 자동으로 조회에서 '
                  '제외됩니다 — 공유를 끄지 않고 앱을 종료해도 그 이후로는 다른 이용자에게 노출되지 않습니다.\n'
            ...
            const _Section(
              ...
              body:
                  ...
                  '• 「위치공유」를 켠 경우, 가장 가까운 관광 스팟 근처에 있었다는 사실과 그 시각이 '
                  '다른 이용자에게 익명으로 공개됩니다. 정확한 좌표·닉네임·프로필은 포함되지 않으며, '
                  '측정 시점으로부터 30분이 지난 뒤에만 노출됩니다. 이용자별로 최신 위치 1건만 '
                  '유지되고 이전 위치는 갱신 시 덮어써집니다. 기본값은 꺼짐이며 지도 화면에서 '
                  '언제든 켜고 끌 수 있습니다.',
            ),
            const _Section(
              title: '6. 개인정보 처리의 위탁',
