          ...
          children: [
            ...
            const _Section(
              ...
              body:
                  ...
                  '지역별 정복률 계산\n'
                  '• 걸어온 자리 — 앱을 다시 켰을 때 걷힌 안개를 그대로 되살리기 위해서만 사용합니다. '
                  '지역별 정복률은 방문 인증 기록으로만 계산하며, 걸어온 자리는 반영되지 않습니다.\n'
            ...
            const _Section(
              ...
              body:
                  ...
                  '• 위치정보는 앱이 실행 중일 때만 수집합니다. 백그라운드에서 위치를 수집하지 않습니다.\n'
                  '• 주변 관광 스팟·발자취를 조회하기 위해 현재 위치 좌표가 서버로 전송됩니다. '
                  '이 좌표는 조회에만 사용되고 그 자체로는 서버에 저장되지 않습니다.\n'
                  '• 서버에 저장되는 좌표는 세 가지입니다 — 방문 인증을 한 지점, 발자취를 남긴 '
                  '지점, 그리고 지도에서 안개가 걷힌 지점.\n'
                  '• 세 번째가 이용자가 따로 행위를 하지 않아도 쌓이는 유일한 좌표입니다. 앱이 실행 '
                  '중인 동안 약 15m 이동할 때마다 지점 하나가 기록되며, 이는 안개가 걷힌 자리를 앱을 '
                  '다시 켰을 때 되살리기 위한 것입니다. 이 기록은 본인만 조회할 수 있고 다른 이용자에게 '
                  '공개되지 않으며, 회원 탈퇴 시 함께 파기됩니다. 앱을 종료하면 그 시점부터 기록되지 '
                  '않습니다.\n'
            ...
            const _Section(
              ...
              body:
                  '• 앱의 프로필 화면에서 직접 회원 탈퇴할 수 있으며, 탈퇴하는 즉시 계정과 '
                  '관련 정보(방문 인증 기록·사진, 발자취와 좋아요, 동행 요청·수락 이력, '
                  '성향 결과, 걸어온 자리)를 파기합니다. 되돌릴 수 없습니다.\n'
                  '• 앱을 이용할 수 없는 상황이라면 11장의 연락처로 요청해 주셔도 됩니다.\n'
            ...
            const _Section(
              ...
              body:
                  ...
                  '• 회원 탈퇴 및 개인정보 삭제 — 앱의 프로필 화면에서 직접 수행 '
                  '(연락처로 요청하셔도 됩니다)',
            ),
            const _Section(
