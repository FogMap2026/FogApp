            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  // 🔴 이 항목이 나머지와 «다르다» — 다른 좌표는 이용자가 무언가를 눌러야
                  //    남지만 이것은 «걷기만 해도» 쌓인다. 그래서 무엇이·언제·왜·누가 보나를
                  //    다 적는다. 「위치정보」 안에 한 줄로 끼워 넣으면 동의를 받은 것이 아니다.
                  const _CollectionItem(
                    title: '걸어온 자리',
                    detail:
                        '앱 실행 중 약 15m 이동할 때마다 그 지점이 기록됩니다. '
                        '앱을 다시 켰을 때 걷힌 안개를 그대로 되살리기 위한 것이며, '
                        '본인만 볼 수 있고 다른 이용자에게 공개되지 않습니다. '
                        '탈퇴하면 함께 삭제됩니다.',
                  ),
                  const _CollectionItem(
                    title: '사진',
