...
///
/// `MapScreen._requestLocationPermission()`과 `LocationService.start()`
/// (지도 SDK가 트래커의 `startLocationService()`를 부를 때 — 네이티브 "내 위치" 버튼
/// 탭 시에도 호출됨)가 각자 독립적으로 `Geolocator.requestPermission()`을 호출할 수 있는데, 두 호출이
